  ...
  switch (path) {
    ...
    case "/api/family/tasks": {
      ...
      return [
        {
          id: "mock-task-1",
          title: "Pack school bags for tomorrow",
          note: "Elias ja Elise: tarkista kirjat, liikuntavaatteet ja välipalat.",
          labels: ["home", "school"],
          size: 4,
          assignee: "Äiti",
          createdAt: now.minus({ hours: 6 }).toISO(),
        },
        {
          id: "mock-task-2",
        ...
        },
        {
          id: "mock-task-3",
          title: "Fold laundry",
          note: "Pyykit kuivurista kaappiin ennen iltaa.",
          labels: ["home"],
          size: 2,
